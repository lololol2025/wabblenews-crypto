    ...
    <div className="min-h-screen pt-24">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <motion.div
          ...
          className="glass-effect border border-gray-800 rounded-3xl p-12 md:p-20"
        >
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed">
            <p className="text-2xl leading-loose font-light">
            ...
            <div className="glass-effect border border-primary/20 rounded-3xl p-12 my-10">
              <h2 className="text-4xl font-black text-white mb-8">Our Values</h2>
              <ul className="space-y-6">
                <li className="flex items-start">
                  <span className="text-primary mr-5 text-3xl font-black">↗</span>
                  <span className="text-xl font-light leading-relaxed"><strong className="text-white font-black">Speed:</strong> Breaking crypto news delivered in real-time</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-5 text-3xl font-black">↗</span>
                  <span className="text-xl font-light leading-relaxed"><strong className="text-white font-black">Accuracy:</strong> We verify our sources and fact-check everything</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-5 text-3xl font-black">↗</span>
                  <span className="text-xl font-light leading-relaxed"><strong className="text-white font-black">Innovation:</strong> Ultra-modern platform with advanced features</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-5 text-3xl font-black">↗</span>
                  <span className="text-xl font-light leading-relaxed"><strong className="text-green-400 font-black">Community:</strong> Powered by Crypto Wabble community</span>
                </li>
              </ul>
            </div>
